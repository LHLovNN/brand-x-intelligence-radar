...
BRAND_RADAR_DITING_LAUNCHD_LABEL="${BRAND_RADAR_DITING_LAUNCHD_LABEL:-com.brand-radar.diting-digests}"
BRAND_RADAR_HEALTH_LAUNCHD_LABEL="${BRAND_RADAR_HEALTH_LAUNCHD_LABEL:-com.brand-radar.healthcheck}"
