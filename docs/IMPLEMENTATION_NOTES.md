...
- `09:00`: primary public freshness check with bounded module repair.
- `11:00`: conditional follow-up; it exits from a local success marker when the primary check found all four modules current.
